...
const ClientMessageTypeSchema = z.enum(["AUTHENTICATE_USER", "CREATE_GAME", "JOIN_ROOM", "LEAVE_ROOM", "START_GAME", "SOLUTION_SUBMIT", "MESSAGE", "SEND_CHAT_MESSAGE", "PENALTY", "RESTART_GAME"]);
